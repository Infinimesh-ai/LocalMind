...
let dotLottiePromise: Promise<unknown> | null = null;

class LoadDotLottieDirective extends Directive {
  override render() {
    if (typeof window !== 'undefined') {
      dotLottiePromise ??= import('@lottiefiles/dotlottie-wc');
      dotLottiePromise.catch(console.error);
    }
    return nothing;
  }
}

export const loadDotLottie = directive(LoadDotLottieDirective);

export const AIStarIconWithAnimation = html`${loadDotLottie()}<dotlottie-wc
