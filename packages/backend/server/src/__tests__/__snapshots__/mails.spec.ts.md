        ...
        <tr>␊
          <td>␊
            <p␊
              ...
              This is a test email from your LocalMind instance.␊
            </p>␊
          </td>␊
        </tr>␊
      </tbody>␊
            ...
            <table␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    style="font-size:15px;line-height:24px;font-weight:400;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
                    You are signing in to LocalMind. Here is your code:␊
                  </p>␊
                </tr>␊
              </tbody>␊
            </table>␊
    ...
    123456</pre␊
            ...
            <table␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <a␊
                    href="https://localmind.example/magic-link?token=123456&amp;email=test@test.com"␊
                    style="line-height:24px;text-decoration:none;display:inline-block;max-width:100%;mso-padding-alt:0px;font-size:15px;font-weight:600;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#FFFFFF;background-color:#F43D32;padding:8px 18px;border-radius:8px;border:1px solid rgba(0,0,0,.1);margin-right:4px;padding-top:8px;padding-right:18px;padding-bottom:8px;padding-left:18px"␊
                    target="_blank"␊
                    ><span␊
                      ><!--[if mso␊
...
> Your LocalMind account is waiting for you!
            ...
            <table␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    style="font-size:15px;line-height:24px;font-weight:400;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
                    You are signing up to LocalMind. Here is your code:␊
                  </p>␊
                </tr>␊
              </tbody>␊
            </table>␊
...
> Modify your LocalMind password
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    ...
                    with your LocalMind account.<br />To complete this process,␊
      ...
      <tbody>␊
        <tr>␊
          <td>␊
            <p␊
              style="font-size:20px;line-height:28px;font-weight:600;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
              Verify your current email for LocalMind␊
            </p>␊
          </td>␊
        </tr>␊
      </tbody>␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    style="font-size:15px;line-height:24px;font-weight:400;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
                    You recently requested to change the email address associated␊
                    with your LocalMind account. To complete this process, please␊
      ...
      <tbody>␊
        <tr>␊
          <td>␊
            <p␊
              style="font-size:20px;line-height:28px;font-weight:600;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
              Your LocalMind email address was changed␊
            </p>␊
          </td>␊
        </tr>␊
      </tbody>␊
        ...
        <tr>␊
          <td>␊
            <p␊
              ...
              you&#x27;re using␊
              <span style="font-weight:600">test@localmind.example</span> to log in␊
              the next time.␊
            </p>␊
          </td>␊
        </tr>␊
...
> You were invited to join a workspace on LocalMind
    ...
    <link␊
      rel="preload"␊
      as="image"␊
      href="https://localmind.example/favicon-192.png" /><!--$-->␊
    <table␊
      align="center"␊
      width="100%"␊
      border="0"␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    ...
                    to join␊
                    <img␊
                      src="https://localmind.example/favicon-192.png"␊
                      alt="avatar"␊
...
> You were mentioned in LocalMind
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    ...
                    <span style="font-weight:600">2025-01-30</span>. To prevent data␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    ...
                    <span style="font-weight:600">2024-12-31</span>. All workspace␊
                    data will be permanently deleted on␊
                    <span style="font-weight:600">2025-01-30</span> (180 days after␊
            ...
            <table␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    style="font-size:15px;line-height:24px;font-weight:400;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
                    Thank you for your support of LocalMind. We hope to see you␊
                    again in the future.␊
                  </p>␊
                </tr>␊
              </tbody>␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    ...
                    <span style="font-weight:600">2024-12-31</span>. After␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    ...
                    >␊
                    team workspace expired on<!-- -->␊
                    <span style="font-weight:600">2024-12-31</span>. Your workspace␊
