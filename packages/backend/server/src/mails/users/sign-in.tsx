...
export default function SignIn(props: SignInProps) {
  return (
    <Template>
      <Title>{`Sign in to ${props.serverName ?? 'LocalMind'}`}</Title>
      <Content>
        <P>You are signing in to LocalMind. Here is your code:</P>
...
SignIn.PreviewProps = {
  url: 'https://localmind.example/magic-link?token=123456&email=test@test.com',
  otp: '123456',
};
