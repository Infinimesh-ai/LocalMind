...
export const colorControl = style({
  ...
  selectors: {
    ...
    '&[data-disabled="true"]': { cursor: 'default', opacity: 0.45 },
    '&[data-disabled="true"]:hover': { background: 'transparent' },
  },
});
...
globalStyle(`${colorControl} input:disabled`, {
  cursor: 'default',
});
