...
const PaymentRequiredErrorRenderer = (host?: EditorHost | null) => html`
  <ai-error-wrapper
    .text=${"You've reached the current usage cap for LocalMind AI. Contact your workspace administrator or update the configured AI provider to continue."}
    .actionText=${'Upgrade'}
...
const LoginRequiredErrorRenderer = (host?: EditorHost | null) => html`
  <ai-error-wrapper
    .text=${'You need to log in to LocalMind Cloud to continue using LocalMind AI.'}
    .actionText=${'Login'}
